...
class Experiment(Base):
    ...
    experimental_data = relationship("ExperimentalData", back_populates="experiment", cascade="all, delete-orphan")
    results = relationship("Results", back_populates="experiment", cascade="all, delete-orphan")
...
class ExperimentalData(Base):
    ...
    experiment = relationship("Experiment", back_populates="experimental_data")
